...
### Folder Structure:
 ...
 In /backend, index.ts is the file you load to start the bot, while the source code for the bot itself is in bot.ts. 
...
After doing those things, you should be able to `node index.ts` in the commandline and run the bot!
