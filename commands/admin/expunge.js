export async function expunge(message, expungeCount) {
  // TODO: make this not super slow
  if (!message.guild.member(message.author).hasPermission('MANAGE_MESSAGES')) return message.reply('you do not have sufficient perms to do that!'); // restricts this command to mods only, maybe require different perms?
